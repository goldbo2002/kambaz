export default function Lab1() {
  return (
    <div className="container">
      ...
      <p><b>Section:</b> [Your Section]</p>
      <ul>
        <li><a href="#/Labs/Lab1">Lab 1</a></li>
        <li><a href="#/Kambaz">Kambaz App</a></li>
        <li><a href="https://github.com/YOUR_USERNAME/kambaz-react-web-app" target="_blank">Source Code on GitHub</a></li>
      </ul>
      ...
      <a href="https://www.lipsum.com" target="_blank" rel="noopener noreferrer">Get dummy text</a><br/>
      <a href="https://github.com/YOUR_USERNAME/kambaz-react-web-app" target="_blank" rel="noopener noreferrer">GitHub Repo</a>
    </div>
  );
}
